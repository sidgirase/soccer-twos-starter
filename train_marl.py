...
# Disable Ray dashboards to prevent PACE node socket errors
...
def env_creator(env_config):
    """Creates the environment with robust collision prevention."""
    ...
    for attempt in range(30):
        try:
            ...
            return RoleBasedSoccerTwos(env)
...
if __name__ == "__main__":
    # We put this print statement FIRST so you know the script is actually running!
    ...
    config = {
        ...
        # --- THE FIX FOR SIDE-BY-SIDE SPAWNING ---
        # Reverting to a SHARED brain. This doubles learning speed 
        # and ensures both agents act aggressively based on the velocity rewards!
        "multiagent": {
